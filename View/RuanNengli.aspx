<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RuanNengli.aspx.cs" Inherits="MatrixTool.View.RuanNengli" %>
    ...
    <div class="content">
        <div class="cont">
            <div style="text-align:center" >
                <a href="https://novonordisk.wjx.cn/jq/18486371.aspx" style="text-decoration:underline; " >通用能力培训报名</a>
            </div>
            <div class="position">
                <span class="SunFont">通用能力培训/</span> <span class="VerdFont">General Competence Training</span> 
            </div>
       <div class="line4" id="printdiv">
        <div class="table_wrap clear">
            <div class="lr_all" id="wrap">
	            <div class="left" style="width:260px">
        	            ...
        	            <table class="datagrid-htable" border="0" cellspacing="0" cellpadding="0" style="height: 26px; width:260px;">
                            ...
                            <tr>
                                <td>
                       	                <div class="datagrid-title" style="width:130px;"><span>课程名称<br/>Course Name</span></div>
                                </td>
                                </tr>
                            </tbody>
                            </table>
          ...
          <td style="width:3%">
           ...
           <td>
             ...
             <td style="text-align:right;width:300px">
                  <asp:Button ID="btn_save" class="save_button" runat="server" Text="Export Excel"  onclick="btn_save_Click" Width="120px" />
                  &nbsp; &nbsp;
                  <asp:Button ID="ID_Back" class="prew_button" runat="server" Text="Back" onclick="ID_Back_Click"  Width="70px" />
